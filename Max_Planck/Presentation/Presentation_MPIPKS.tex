...
\begin{column}{.55\textwidth}
	\flushright
	\begin{figure}[htp!]	 
	\includegraphics[trim={-0.1cm 0cm 2.5cm 0cm}, width= 1 \linewidth]{Illustrations/transport_W_EF.png} 
	\caption*{Two-terminal transport along $x$-direction. (a) OBC along $y$, (b) PBC along $y$. Inset: Finite size scaling.}
	\end{figure}
\end{column}
\end{columns}
\blfootnote{B. Michen and J. C. Budich,
...
\begin{frame}
\frametitle{\insertsectionhead}
\textbf{\large Floquet topology}

	\begin{itemize}[<+->]
		\item Define Floquet ground states? \footnote{P. M. Schindler and M. Bukov, \emph{Geometric Floquet Theory},
\href{https://journals.aps.org/prx/abstract/10.1103/7l91-gw77}{PRX {\bfseries{15}} (3), 031037 (2025)}}
	\end{itemize}
\end{frame}
