...
\begin{frame}
\frametitle{\insertsectionhead}
\textbf{\large State preparation strategy \\}
\vspace{0.5em}
Break parity symmetry through single-particle tunneling with flux $\phi$
\begin{align}
...
\end{align}
\pause
$\Rightarrow$ For flux $\phi = \nu$  commensurate with filling, this gaps out critical target state.
\pause
\vspace{1em}
